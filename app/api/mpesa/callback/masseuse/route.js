...
export async function POST(req) {
    ...
    console.log("Masseuse M-Pesa Callback:", JSON.stringify(data, null, 2));
    ...
    if (data.Body.stkCallback.ResultCode === 0) {
        ...
        await MassageModel.findOneAndUpdate({ phone }, { verified: true, transactionCode });
        ...
        await MassageModel.findOneAndDelete({ phone });
